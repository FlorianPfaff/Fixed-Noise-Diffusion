...
By default the workflow auto-detects `.venv/bin/python`, `python3.12`, or
`python3`. Set the `python_bin` workflow input only when a runner needs a
specific pre-existing Python executable.
