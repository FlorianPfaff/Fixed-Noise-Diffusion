...
CSV_FIELDS = [
    ...
    "pool_size",
    "pool_memory_mb",
    "pool_exposure_tracked",
    "pool_draws",
    "pool_draws_per_entry",
    "pool_unique_entries",
    "pool_unseen_entries",
    "pool_unique_fraction",
    "pool_duplicate_draw_fraction",
    "pool_expected_unique_entries",
    "pool_expected_unique_fraction",
    "pool_expected_duplicate_draw_fraction",
    "pool_max_entry_draws",
    "heldout_pool_seed",
    "config_hash",
    "git_commit",
    "samples_path",
